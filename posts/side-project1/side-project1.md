...
使用來源為交通度高公局交通資料庫的開放資料，[網址](https://tisvcloud.freeway.gov.tw/history/motc20/Section/)。[^1]


[^1]: 資料庫欄位解釋請參照[交通部官方文件](https://drive.google.com/file/d/12GzEhuiZa7yJc5zFGVEn8U9UJR22RrGy/view)

我使用的欄位有：

- SectionID : 機關發布路段代碼[^2]
